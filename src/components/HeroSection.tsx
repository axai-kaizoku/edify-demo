...
const HeroComponent = () => {
	return (
		<Container
			isBorder={false}
			className="py-[2.5rem] sm:pt-5 lg:pt-2 xl:pt-12">
			<div className="w-full flex flex-col-reverse lg:flex-row sm:gap-6 lg:gap-0 justify-center items-center lg:pt-16 lg:pb-14 xl:py-1">
				<div className="flex flex-col justify-start items-start gap-4 w-full lg:pt-[3.1rem] xl:pt-[3.3rem]">
					<div className="w-full flex flex-col justify-start items-start gap-4 lg:gap-8 xl:gap-[60px]">
						<div className="w-full flex flex-col lg:justify-start justify-center items-center lg:items-start gap-3">
							...
							<div className="text-gray-600 md:text-grey-800 text-[0.9rem] sm:text-[1.5rem] lg:text-lg xl:text-3xl whitespace-nowrap font-normal font-graphik leading-snug md:leading-10">
