		...
		<div className="flex justify-center items-center w-full">
			<div className="flex flex-col w-[87%] sm:w-4/5  ">
				<div className="flex flex-col text-center gap-8 py-4 sm:py-14 border-b">
					<h3 className="text-3xl sm:text-5xltext-2xl sm:text-5xl font-manuale font-semibold">
				...
				<div className="flex flex-col">
					<h3 className="text-2xl sm:text-4xl font-tinos font-bold py-6 sm:py-14">
						PRIVACY POLICY
					</h3>
				...
				<ul className="flex flex-col font-tinos leading-5 sm:leading-7 text-base sm:text-lg gap-0.5 sm:gap-4 py-3 sm:py-10">
					<li>
						<h4 className="font-bold text-xl sm:text-3xl pb-7">1. CONSENT</h4>
						<div className="flex flex-col gap-8 pb-6 text-slate-500">
							<p className="font-tinos font-semibold">
					...
					{privacyPolicy.map((v, i) => (
						<li key={i}>
							<h4 className="font-tinos font-bold text-xl sm:text-3xl pb-7">
								{v.title}
							</h4>
							<div className="flex flex-col gap-8 pb-6 text-slate-500">
								{v.desc.map((v, i) => (
