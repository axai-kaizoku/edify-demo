...
export default function Partners() {
	return (
		<div className="flex flex-col md:gap-14 lg:gap-20 pt-10 gap-10 lg:mb-[5rem]">
			<h2 className="text-[1.2rem] sm:text-4xl text-center text-black font-manuale font-semibold ">
