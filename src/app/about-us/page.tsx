...
const MoreLinks = dynamic(() => import('@/components/more-links'));
		...
		<div className="flex justify-center items-center w-full">
			<div className="flex flex-col w-full justify-center items-center">
				<div className="flex flex-col  sm:pb-20 gap-10 ">
					<Container
						isBorder={false}
						className=" sm:py-16 sm:pt-5 lg:pt-2 xl:pt-12">
						<div className="w-full flex flex-col-reverse lg:flex-row lg:gap-0 justify-center items-center lg:pt-24 lg:pb-20 xl:py-12">
							<div className="flex flex-col justify-start items-start gap-4  w-full lg:pt-[3.1rem] xl:pt-[3.3rem]">
								<div className="w-full flex flex-col h-fit justify-start items-start gap-5 lg:gap-8 xl:gap-[60px]">
									<div className="w-full flex flex-col-reverse lg:flex-col h-fit lg:justify-start justify-center items-center lg:items-start sm:gap-8">
										<div className="text-slate-600 md:text-grey-800 text-[0.9rem] lg:text-[1.3rem] xl:text-3xl whitespace-nowrap font-normal font-graphik">
											ONE REFURBISHED LAPTOP AT A TIME
										</div>
										<div className="text-black text-[1.2rem] sm:text-5xl lg:text-[2.9rem] xl:text-6xl whitespace-nowrap font-semibold font-manuale leading-[3.5rem] lg:leading-[46px] xl:leading-[72px]">
					...
					<div className="w-full h-full relative">
						<div className="absolute w-full flex flex-col gap-0 sm:gap-1 lg:gap-1.5 xl:gap-8 pl-[4%] max-sm:-mt-[9%] sm:pl-[6.13%] sm:pt-7 lg:pt-[8%] xl:pt-[9%]">
							...
							<div className="font-graphik text-[0.7rem] sm:text-base lg:text-[1.1rem] xl:text-[1.5rem] w-full flex flex-col lg:gap-1 xl:gap-2 2xl:gap-3 py-2 text-slate-600">
